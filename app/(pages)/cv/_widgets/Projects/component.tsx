	...
	return (
		<>
			<Section title="Key projects in my carier">
				...
				<PageBreak />
				<h2 className="cv-only-print" aria-hidden="true">
					...
					<tbody>
						...
						<tr className="cv-tr-line">
							...
							<td>
								<ul>
									<li>
										Developed a &quot;web soft-phone&quot;
										with a user interface for interaction
										with JsSIP
									</li>
									<li>
										Configured the &quot;web
										soft-phone&quot; component for
										continuous interaction with user in
...
function TableHeading(): ReactElement {
	return (
		<tr>
			<td width={100}>
				<b>Project</b>
