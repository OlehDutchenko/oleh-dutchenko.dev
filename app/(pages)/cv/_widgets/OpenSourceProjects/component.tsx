		...
		<Section title="My open-source projects I am proud of">
			...
			>
				<p>
					...
					<br /> It is a core of postcss-sort-media-queries plugin.
				</p>
			</Block>
			<Block
			...
			>
				<p>
					...
					You can use it as CLI tool or as Node.js module in your CI
					workflow.
				</p>
			</Block>
			...
			<Block title="Tooling libs, Wezom open-source">
				<p>
					I create many of helper tools as open-source libraries for
					commercial needs for Wezom company. See all repositories:{' '}
